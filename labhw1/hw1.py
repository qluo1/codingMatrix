...
# scale 100
plot([(a*1.0*a1[0] + (1-a*1.0)*a2[0],a*1.0*a1[1]+(1-a*1.0)*a2[1])  for a in range(-100,100)],100)

# plot 
plot[ (a/100.0 * a1[0] + (1-a/100.)*a2[0], a/100. * a1[1] + (1-a/100.)*a2[1]) for a in range(0,100)]
